...
* Automatic SAS MV are stored in Global Symbol Table;
* While user defined MV defined outside a macro facitlity are stored in Global symbol table, while those defined inside a macro facitlity are stored in local symbol table;
* Detailed coverage of Global and Local symbol table will be done in chapter11;
